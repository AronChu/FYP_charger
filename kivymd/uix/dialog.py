    ...
    BoxLayout:
        ...
        ScrollView:
            ...
            MDList:
                ...
                ThinBox:
                    ThinLabel:
                        text: "Standard(BS1363): "
                    ThinLabelButton:
                        text: root.StandardBS1363
                ThinBox:
                    ThinLabel:
                        text: "Medium(IEC62196(≦20kW)): "
                    ThinLabelButton:
                        text: root.MediumIEC62196
                ThinBox:
                    ThinLabel:
                        text: "Medium(SAEJ1772): "
                    ThinLabelButton:
                        text: root.MediumSAEJ1772
                ThinBox:
                    ThinLabel:
                        text: "Medium(Others): "
                    ThinLabelButton:
                        text: root.MediumOthers
                ThinBox:
                    ThinLabel:
                        text: "Quick(CHAdeMO):"
                    ThinLabelButton:
                        text: root.QuickCHAdeMO
                ThinBox:
                    ThinLabel:
                        text: "Quick(CCSDCCombo):"
                    ThinLabelButton:
                        text: root.QuickCCSDCCombo
                ThinBox:
                    ThinLabel:
                        text: "Quick(IEC62196(>20kW)):"
                    ThinLabelButton:
                        text: root.QuickIEC62196
                ThinBox:
                    ThinLabel:
                        text: "Quick(GB/T20234.3(DC)):"
                    ThinLabelButton:
                        text: root.QuickGBT
                ThinBox:
                    ThinLabel:
                        text: "Quick(Others): "
                    ThinLabelButton:
                        text: root.QuickOthers
                ThinBox:
                    ThinLabel:
                        text: "Remark for Others: "
                    ThinLabelButton:
                        text: root.RemarkOthers           
                ThinBox:
                    ThinLabel:
                        text: "Queue: "
                    ThinLabelButton:
                ...
                ThinBox:
                    ...
                    ThinLabelButton:
                        text: root.Estimated_Waiting_Time        
        MDSeparator:
            id: sep
...
class ListMDDialog(BaseDialog):
    ...
    StandardBS1363 = StringProperty("Missing data")
    MediumIEC62196 = StringProperty("Missing data")
    MediumSAEJ1772= StringProperty("Missing data")
    MediumOthers = StringProperty("Missing data")
    QuickCHAdeMO = StringProperty("Missing data")
    QuickCCSDCCombo = StringProperty("Missing data")
    QuickIEC62196 = StringProperty("Missing data")
    QuickGBT = StringProperty("Missing data")
    QuickOthers = StringProperty("Missing data")
    RemarkOthers = StringProperty("Missing data")
    Queue = StringProperty(" ")
    Estimated_Waiting_Time = StringProperty(" ")
